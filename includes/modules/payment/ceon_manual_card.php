...
class ceon_manual_card
{
	...
	function after_process()
	{
		...
		zen_mail(CEON_MANUAL_CARD_EMAIL, CEON_MANUAL_CARD_EMAIL, CEON_MANUAL_CARD_TEXT_EMAIL_SUBJECT . $insert_id,
			$message, STORE_NAME, EMAIL_FROM, $html_msg, 'cc_middle_digs');
	}
